...
# System config
use constant ADMIN_PASS => 'supercow';			# Admin password. For fucks's sake, change this.
use constant SECRET => 'k4reha rules';				# Cryptographic secret. CHANGE THIS to something totally random, and long.
